...
<div class="space-y-6 max-w-3xl">
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-xs text-gray-500 mt-1">Buat program unggulan baru untuk ditampilkan di situs utama (mendukung Bahasa Indonesia & English).</p>
        </div>
        ...
        <form action="{{ route('admin.programs.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div id="content-tab-id" class="space-y-5">
                <div>
                    ...
                    <input type="text" id="title" name="title" required value="{{ old('title') }}" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-xs focus:border-brand-green focus:ring-1 focus:ring-brand-green outline-none transition" placeholder="Contoh: Sekolah Aman Bencana (SPAB)">
                ...
                <div class="bg-amber-50/50 p-4 rounded-xl border border-amber-200/60">
                    ...
                    <textarea id="short_description" name="short_description" rows="2" maxlength="500" class="w-full border border-amber-200 rounded-lg px-3.5 py-2 text-xs focus:border-brand-green focus:ring-1 focus:ring-brand-green outline-none transition bg-white" placeholder="Contoh: Membangun budaya sadar bencana di sekolah dan masyarakat.">{{ old('short_description') }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="6" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-xs focus:border-brand-green focus:ring-1 focus:ring-brand-green outline-none transition" placeholder="Tulis deskripsi program secara lengkap di sini...">{{ old('description') }}</textarea>
            ...
            <div id="content-tab-en" class="space-y-5 hidden">
                <div>
                    ...
                    <input type="text" id="title_en" name="title_en" value="{{ old('title_en') }}" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-xs focus:border-brand-green focus:ring-1 focus:ring-brand-green outline-none transition" placeholder="e.g. Disaster Preparedness School (SPAB)">
                ...
                <div>
                    ...
                    <textarea id="description_en" name="description_en" rows="6" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-xs focus:border-brand-green focus:ring-1 focus:ring-brand-green outline-none transition" placeholder="Write full program description in English...">{{ old('description_en') }}</textarea>
            ...
            <div>
                <label for="image_url" class="block text-xs font-bold text-gray-700 uppercase mb-2">Gambar Utama Program <span class="text-red-500">*</span></label>
