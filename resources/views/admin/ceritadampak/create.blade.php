...
<div class="space-y-6 max-w-4xl text-xs">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-extrabold text-gray-900">Tambah Cerita Lapangan</h1>
            <p class="text-xs text-gray-500 mt-1">Buat artikel kisah lapangan baru dari daerah dampingan pesisir.</p>
        </div>
        ...
        <form action="{{ route('admin.stories.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div id="content-tab-id" class="space-y-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="title_id" name="title_id" required value="{{ old('title_id') }}" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-xs focus:border-brand-green focus:ring-1 focus:ring-brand-green outline-none transition" placeholder="Masukkan judul menarik">
                    ...
                    <div>
                        ...
                        <input type="text" id="category_id" name="category_id" required value="{{ old('category_id') }}" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-xs focus:border-brand-green focus:ring-1 focus:ring-brand-green outline-none transition" placeholder="Contoh: SPAB Cijayana, Tabur Laut">
                ...
                <div>
                    ...
                    <textarea id="description_id" name="description_id" rows="2" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-xs focus:border-brand-green focus:ring-1 focus:ring-brand-green outline-none transition" placeholder="Tulis ringkasan singkat untuk tampilan kartu depan homepage">{{ old('description_id') }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="content_id" name="content_id" rows="10" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-xs focus:border-brand-green focus:ring-1 focus:ring-brand-green outline-none transition" placeholder="Tuliskan seluruh isi artikel/kisah lapangan di sini.">{{ old('content_id') }}</textarea>
                ...
                <div>
                    ...
                    <input type="text" id="impact_label_id" name="impact_label_id" value="{{ old('impact_label_id') }}" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-xs focus:border-brand-green focus:ring-1 focus:ring-brand-green outline-none transition" placeholder="Masukkan deskripsi metrik dampak dalam Bahasa Indonesia">
            ...
            <div id="content-tab-en" class="space-y-6 hidden">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="title_en" name="title_en" required value="{{ old('title_en') }}" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-xs focus:border-brand-green focus:ring-1 focus:ring-brand-green outline-none transition" placeholder="Enter engaging English title">
                    ...
                    <div>
                        ...
                        <input type="text" id="category_en" name="category_en" required value="{{ old('category_en') }}" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-xs focus:border-brand-green focus:ring-1 focus:ring-brand-green outline-none transition" placeholder="e.g. SPAB Cijayana, Tabur Laut">
                ...
                <div>
                    ...
                    <textarea id="description_en" name="description_en" rows="2" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-xs focus:border-brand-green focus:ring-1 focus:ring-brand-green outline-none transition" placeholder="Write short summary for front card homepage in English">{{ old('description_en') }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="content_en" name="content_en" rows="10" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-xs focus:border-brand-green focus:ring-1 focus:ring-brand-green outline-none transition" placeholder="Write full article body text in English here.">{{ old('content_en') }}</textarea>
                ...
                <div>
                    ...
                    <input type="text" id="impact_label_en" name="impact_label_en" value="{{ old('impact_label_en') }}" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-xs focus:border-brand-green focus:ring-1 focus:ring-brand-green outline-none transition" placeholder="Enter English impact metric description">
            ...
            <div class="border-t border-gray-150 pt-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    <div>
                        <label for="image_url" class="block text-xs font-bold text-gray-700 uppercase mb-2">Foto Utama Artikel (Thumbnail)</label>
                    ...
                    <div>
                        ...
                        <select id="program_id" name="program_id" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-xs focus:border-brand-green focus:ring-1 focus:ring-brand-green outline-none transition font-semibold">
                            ...
                            @foreach($programs as $prog)
                                <option value="{{ $prog->id }}" {{ old('program_id') == $prog->id ? 'selected' : '' }}>{{ $prog->title }}</option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" id="impact_number" name="impact_number" value="{{ old('impact_number') }}" class="w-full border border-gray-200 rounded-lg px-4 py-2 text-xs focus:border-brand-green focus:ring-1 focus:ring-brand-green outline-none transition" placeholder="Contoh: 450+, 85%">
                        @error('impact_number') <p class="text-red-500 text-[10px] mt-1">{{ $message }}</p> @enderror
                    </div>
                </div>

                <!-- Gallery Multi Image Input -->
                <div class="border-t border-gray-100 pt-6">
                    <label for="gallery" class="block text-xs font-bold text-gray-700 uppercase mb-2">Unggah Foto Galeri Dokumentasi (Bisa pilih banyak sekaligus)</label>
            ...
            <div class="pt-6 flex justify-end gap-3 border-t border-gray-100">
                ...
                <button type="submit" class="bg-brand-green text-white text-xs font-bold px-6 py-2.5 rounded-lg hover:bg-brand-darkgreen shadow transition">Simpan Artikel</button>
            </div>
        </form>
    </div>
</div>
