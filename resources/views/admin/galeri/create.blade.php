        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-150 p-6 sm:p-8">
            <form action="{{ route('admin.galleries.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', 0) }}" required class="w-32 bg-gray-50 border border-gray-200 focus:border-brand-green focus:bg-white rounded-lg p-2.5 text-xs outline-none transition">
